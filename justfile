...
wasm example *args:
    CONNECT='ws/127.0.0.1:7446' RUST_LOG='info' RUSTFLAGS='--cfg getrandom_backend="wasm_js"' cargo build --example {{example}} --no-default-features --features=wasm --target wasm32-unknown-unknown -- {{args}}
