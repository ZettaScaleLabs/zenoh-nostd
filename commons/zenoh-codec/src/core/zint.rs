    ...
    R: Reader,
{
    ...
    fn read(self, reader: &mut R) -> ZResult<u8> {
        reader.read_u8()
    }
}
    ...
    R: Reader,
{
    ...
    fn read(self, reader: &mut R) -> ZResult<u64> {
...
macro_rules! uint_impl {
    ($uint:ty) => {
            ...
            R: Reader,
        {
            ...
            fn read(self, reader: &mut R) -> ZResult<$uint> {
...
macro_rules! zint_impl_codec {
    ($zint:ty, $bound:ty) => {
            ...
            R: Reader,
        {
            ...
            fn read(self, reader: &mut R) -> ZResult<$zint> {
...
//     fn read(self, reader: &mut R) -> ZResult<usize> {
