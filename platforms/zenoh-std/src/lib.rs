use {
    ...
    zenoh_nostd::{ZResult, platform::Platform},
};
...
impl Platform for PlatformStd {
    ...
    ) -> ZResult<Self::AbstractedWsStream, zenoh_nostd::ZConnectionError> {
    ...
    ) -> ZResult<Self::AbstractedTcpStream, zenoh_nostd::ZConnectionError> {
